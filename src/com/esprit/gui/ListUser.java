...
//        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
    ...
    private void addButton(Image img,User u , Resources res) {
       ...
       // Label objetTxt = new Label("Date : "+rec.getDate(),"NewsTopLine2");
        Label usernameTxt = new Label("Username: "+u.getUsername(),"NewsTopLine2");
        Label emailTxt = new Label("Email : "+u.getEmail(),"NewsTopLine2" );
        Label phoneTxt = new Label("Phone : "+u.getPhone(),"NewsTopLine2" );
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(usernameTxt),
                BoxLayout.encloseX(emailTxt),
                BoxLayout.encloseX(phoneTxt,lModifier,lSupprimer)));
